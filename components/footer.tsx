...
export default function Footer() {
  ...
  return (
    <footer className="bg-muted/30 pt-16 pb-8 relative" ref={footerRef}>
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary/30 to-transparent"></div>
      <div className="absolute top-0 left-1/4 w-1 h-8 bg-primary/20 rounded-b-full"></div>
      <div className="absolute top-0 right-1/4 w-1 h-8 bg-primary/20 rounded-b-full"></div>
      ...
      <div className="container mx-auto px-4">
          ...
          <div ref={(el) => (columnsRef.current[0] = el)} className="opacity-0 transform translate-y-8">
            <div className="flex items-center mb-4">
              <div className="relative h-10 w-32">
                <Image src="/images/logo.png" alt="EL Innovate Logo" fill className="object-contain" />
              </div>
              <span className="text-lg font-semibold tracking-tight text-primary relative">
                innovatives
            ...
            <div className="flex space-x-4">
              <Button
                ...
                size="icon"
                asChild
                className="hover:scale-110 transition-transform relative overflow-hidden group"
              >
                <a
                  href="https://www.facebook.com/profile.php?id=61551850065620"
                  target="_blank"
              ...
              >
                <a
                  href="https://www.instagram.com/elinterio_/"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <Button
                ...
                className="hover:scale-110 transition-transform relative overflow-hidden group"
              >
                <a href="mailto:info@elinnovative.com" aria-label="Email">
              ...
              >
                <a
                  href="https://api.whatsapp.com/send/?phone=918879660444&text&type=phone_number&app_absent=0"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                >
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start group">
                ...
                <span className="text-muted-foreground group-hover:text-foreground transition-colors">
                  134, RISHABH TUFF, PLOT NO A-133, MIDC Rd, Thakurli, GOLIVALI 1, Dombivli East, Asade, Dombivli,
                  Maharashtra 421201
                </span>
              </li>
            </ul>
        ...
        >
          <p>&copy; {new Date().getFullYear()} EL Innovate. All rights reserved.</p>
          <p className="mt-2">
