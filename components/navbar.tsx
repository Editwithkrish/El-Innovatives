        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center group">
            <div className="flex items-center">
              ...
              <span className="text-lg font-semibold tracking-tight text-primary transition-all duration-300 group-hover:scale-105 relative">
                <span className="relative z-10">innovatives</span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-primary/50 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
                <span className="absolute -inset-1 bg-primary/5 rounded-lg scale-y-0 group-hover:scale-y-100 transition-transform duration-300 -z-10"></span>
              </span>
            </div>
          </Link>
